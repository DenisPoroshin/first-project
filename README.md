...
7. Модуль process_bank.py: Функции для поиска операций по ключам и категориям.
8. Модуль main.py: Функция, которая отвечает за основную логику проекта и связывает функциональности между собой.
## Тестирование:
